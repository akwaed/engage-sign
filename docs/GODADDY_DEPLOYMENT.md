...
Do not add SMTP secrets yet; email delivery has not been implemented. Add `PRIVATE_STORAGE_PATH` only after GoDaddy confirms the persistent private directory outside the public web root.
